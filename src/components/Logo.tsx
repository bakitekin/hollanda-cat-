...
const Logo: React.FC<LogoProps> = ({ className, width, height, title = 'BRK DAK Logo' }) => (
  ...
  >
    <g>
      ...
      <text x="157" y="139" fill="#346B9E" fontFamily="system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif" fontSize="26" fontWeight="600">INSPECTIE & ADVIES</text>
    </g>
  </svg>
);
